(function()
{
    return function()
    {
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::sampletest1.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::sampletest1.xfdl");
        ...
        this.loadIncludeScript("sampletest.xadl", true);
    };
}
)();
